...
static void render_luna(int LUNA_X, int LUNA_Y) {
    ...
    oled_write("                    ", false); // Clear line 1
    oled_set_cursor(LUNA_X, LUNA_Y + 1);
    oled_write("                    ", false); // Clear line 2
    oled_set_cursor(LUNA_X, LUNA_Y + 2);
    oled_write("                    ", false); // Clear line 3
    ...
    // Select and write animation frame
    if (isSneaking) {
...
static void print_logo_narrow(void) {
    oled_set_cursor(0, 1);
    oled_write("TULIP", false);

    oled_set_cursor(0, 3);
    oled_write("Depr.", false);
    oled_set_cursor(0, 4);
    oled_write("Elect.", false);
    oled_set_cursor(0, 5);
    oled_write("Aton.", false);
    oled_set_cursor(0, 6);
    oled_write("Grace", false);
    oled_set_cursor(0, 7);
    oled_write("Pers.", false);
...
// Modify oled_task_user to handle the animation timing
